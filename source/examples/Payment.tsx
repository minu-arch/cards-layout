import { ChevronsUpDownIcon, CreditCardIcon } from "lucide-react"
import { Apple, EuroIcon, CheckIcon } from "lucide-react"
import { Container, Grid, Stack } from "styled-system/jsx"
import { Input, RadioButtonGroup, Select } from "~/ui"
import { Button, Card, FormLabel } from "~/ui"
		...
		<Card.Root boxShadow="xs">
			...
			<Card.Body gap="4">
				<RadioButtonGroup.Root defaultValue="card" variant="outline">
					<Grid columns={3} width="full">
						{[
							{ value: "card", label: "Card", icon: CreditCardIcon },
							{ value: "paypal", label: "Paypal", icon: EuroIcon },
