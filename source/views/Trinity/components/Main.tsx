...
export const GroupTitle = () => (
	<Stack w="100%" mt="5">
		<Box w="100%" h="0.2" bg="neutral.11" mt="7" />
		<Text
			mt="5"
			as="h2"
			fontSize={{ base: "xl", "@md": "2xl", "@lg": "3xl" }}
			...
			p="5"
		>
			Trinity offers a range of investment types that suit your retirement goals.
		</Text>
		<Box
			display="flex"
		...
		>
			<HStack justifyContent="space-between" gap="5">
				<Box w="0.2" h={{ base: "111", "@md": "100%" }} bg="neutral.11"></Box>
				...
				<Stack>
					...
					<Text color="grass.7" fontWeight="medium">
						Goal-based Planning
					</Text>
					<Text fontSize="sm" color="grass.8">
						Provides customized investment strategies tailored to help users achieve
						their retirement.
					</Text>
				</Stack>
			</HStack>
			<HStack justifyContent="space-between" gap="5">
				<Box w="0.2" h={{ base: "111", "@md": "100%" }} bg="neutral.11" />
				...
				<Stack>
					...
					<Text fontSize="sm" color="grass.8">
						Monitors the performance of users' portfolios and automatically adjust asset
						allocations.
					</Text>
				</Stack>
			</HStack>
			<HStack justifyContent="space-between" gap="5">
				...
				<Stack>
					...
					<Text fontSize="sm" color="grass.8">
						Allows users to visualize their projected income streams to make informed
						decisions.
					</Text>
				</Stack>
			</HStack>
